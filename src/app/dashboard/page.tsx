...
import { DreamStudio } from '@/components/dashboard/DreamStudio';
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <main id="main-content" className="max-w-2xl mx-auto px-4 py-10 space-y-14">
        ...
        <section>
          <div className="mb-8">
            <h1 className="font-display text-3xl font-semibold text-forest">Dream Studio</h1>
            <p className="font-sans text-forest/55 text-sm mt-1">
              {featuredBoard
                ? 'Define it. Visualize it. Iterate.'
