...
export async function sendVisionBoardReady({
  to,
  firstName,
  imageUrl,
  dreams,
  ...
  const greeting = firstName ? `Hi ${firstName},` : 'Hi there,';
  const dreamsSnippet = dreams.length > 300 ? dreams.slice(0, 297) + '…' : dreams;
    ...
    html: `
      ...
      <html>
        <head>
          <meta charset="utf-8" />
          <meta name="viewport" content="width=device-width, initial-scale=1" />
          <title>Your Vision Board Is Ready</title>
        </head>
        <body style="background:#f9f6ef;font-family:'DM Sans',Arial,sans-serif;color:#162420;margin:0;padding:0;">
          <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;margin:40px auto;background:#f9f6ef;border-radius:12px;overflow:hidden;border:1px solid #d4ddd9;">
            <tr>
              <td style="background:hsl(150,22%,38%);padding:32px 40px;text-align:center;">
                <h1 style="font-family:Georgia,serif;color:#fff;font-size:28px;font-weight:300;margin:0;letter-spacing:0.05em;">Manifesta</h1>
                <p style="color:rgba(255,255,255,0.8);font-size:13px;margin:8px 0 0;">Your vision board is ready ✨</p>
              </td>
            </tr>
            <tr>
              <td style="padding:40px;">
                ...
                <!-- Vision board image -->
                <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;border-radius:12px;overflow:hidden;">
                  <tr>
                    <td style="text-align:center;">
                      <a href="${dashboardUrl}" style="display:block;">
                        <img src="${imageUrl}" alt="Your Vision Board" width="480" style="width:100%;max-width:480px;border-radius:12px;display:block;border:0;" />
                      </a>
                    </td>
                  </tr>
                </table>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                  <tr>
                    <td style="text-align:center;padding:4px 0;">
                      <a href="${dashboardUrl}" style="display:inline-block;background:hsl(150,22%,38%);color:#fff;font-size:14px;font-weight:600;text-decoration:none;padding:14px 36px;border-radius:10px;">View &amp; Download My Vision Board →</a>
                    </td>
                  </tr>
                </table>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="background:hsl(43,55%,92%);border-radius:10px;border:1px solid hsl(43,40%,82%);margin-bottom:24px;">
                  <tr>
                    <td style="padding:20px 24px;">
                      <p style="font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:0.08em;color:#5a7a70;margin:0 0 8px;">Your dreams</p>
                      <p style="font-family:Georgia,serif;font-size:14px;font-style:italic;color:#162420;margin:0;line-height:1.7;">&ldquo;${dreamsSnippet}&rdquo;</p>
                    </td>
                  </tr>
                </table>

                <p style="font-size:13px;color:#5a7a70;line-height:1.6;margin:0;">
                  Save this image to your phone and set it as your wallpaper. The more you see your vision, the faster it becomes your reality.
                </p>
              </td>
            </tr>
            <tr>
              <td style="padding:24px 40px;border-top:1px solid #d4ddd9;text-align:center;">
                <p style="font-size:12px;color:#8a9e98;margin:0;">Manifesta &mdash; <a href="${dashboardUrl}" style="color:#5a7a70;text-decoration:none;">joinmanifesta.com</a></p>
              </td>
            </tr>
          </table>
        </body>
